...
<html>
    ...
    <body>
        ...
        <section id="contacto">
            <div id="wrapper">  
                <p>Vous cherchez un nouveau membre à votre équipe de héros ou un allié fiable pour une bataille épique ? Ne cherchez plus !</p>
        ...
        <section id="images">
            <h3>Mis proyectos</h3>
            <h3>Mis proyectos</h3>
            <p class="title">Projet ARUC en relations industrielles of europe  of 1946 </p>
